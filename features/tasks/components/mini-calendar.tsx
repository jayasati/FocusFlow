...
export function MiniCalendar({ dueDays = [] }: { dueDays?: number[] }) {
    ...
    <div className="rounded-[14px] border border-border bg-card p-[14px]">
      ...
      <div className="grid grid-cols-7 gap-0">
        ...
        {days.map((d) => {
          ...
          const hasDot =
            inMonth && isSameMonth(d, cursor) && dueSet.has(d.getDate());
          return (
            <div
              key={d.toISOString()}
            ...
            >
              <div
                className={cn(
                  ...
                  inMonth && !isToday && "text-muted-foreground hover:bg-primary/15 hover:text-foreground",
